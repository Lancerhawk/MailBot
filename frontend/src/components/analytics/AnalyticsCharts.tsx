      ...
      <div className="bg-zinc-900/90 border border-zinc-700 p-3 rounded-lg shadow-xl backdrop-blur-sm">
        ...
        {payload.map((p: Record<string, unknown>, i: number) => (
          <div key={i} className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-zinc-400">{p.name as string}:</span>
            <span className="font-medium text-white">{p.value as React.ReactNode}</span>
          </div>
        ))}
      </div>
    );
...
export function AnalyticsCharts({ data, isLoading, filterParams }: AnalyticsChartsProps) {
  if (isLoading) {
    return (
      <div className="space-y-6">
        <Skeleton className="h-[400px] rounded-xl bg-zinc-900 border border-zinc-800" />
        <Skeleton className="h-[400px] rounded-xl bg-zinc-900 border border-zinc-800" />
      </div>
    );
  }
  ...
  if (!data || data.length === 0) {
    return (
      <div className="h-[400px] rounded-xl border border-dashed border-zinc-800 flex items-center justify-center text-zinc-500 flex-col space-y-3">
  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 w-full">
      ...
      {/* Left Column: All Charts Container (col-span-2) */}
      <div className="order-2 xl:order-1 xl:col-span-2 flex flex-col gap-6 bg-zinc-900/30 border border-zinc-800/80 p-5 lg:p-8 rounded-xl w-full h-full">
        
        {/* Chart 1: Email Processing Volume */}
        <motion.div 
        ...
        >
        <div>
          <h3 className="text-2xl font-bold text-zinc-100">Email Volume</h3>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full h-full">
          ...
          <div className="lg:col-span-5 w-full flex flex-col justify-center space-y-6 lg:pl-6 lg:border-l border-zinc-800/50">
            ...
            <div className="flex flex-col space-y-3 pt-2 w-full">
              <div className="w-full flex justify-between items-center bg-zinc-950/80 p-4 rounded-xl border border-zinc-800/80 shadow-sm">
                 <span className="text-zinc-400 text-sm flex items-center font-medium"><div className="w-2.5 h-2.5 rounded-full bg-blue-500 mr-3"/> Total Received</span>
                 <span className="font-bold text-white text-xl">{totalReceived.toLocaleString()}</span>
              </div>
              <div className="w-full flex justify-between items-center bg-zinc-950/80 p-4 rounded-xl border border-zinc-800/80 shadow-sm">
                 <span className="text-zinc-400 text-sm flex items-center font-medium"><div className="w-2.5 h-2.5 rounded-full bg-purple-500 mr-3"/> Total Replies</span>
                 <span className="font-bold text-white text-xl">{totalReplied.toLocaleString()}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        >
        <div>
          <h3 className="text-2xl font-bold text-zinc-100">Draft Automation</h3>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full h-full">
          <div className="lg:col-span-7 w-full h-[250px] sm:h-[300px] lg:h-[350px]">
            <ResponsiveContainer width="100%" height="100%">
          ...
          <div className="lg:col-span-5 w-full flex flex-col justify-center space-y-6 lg:pl-6 lg:border-l border-zinc-800/50">
            ...
            <div className="flex flex-col space-y-3 pt-2 w-full">
              <div className="w-full flex justify-between items-center bg-zinc-950/80 p-4 rounded-xl border border-zinc-800/80 shadow-sm">
                 <span className="text-zinc-400 text-sm flex items-center font-medium"><div className="w-2.5 h-2.5 rounded-full bg-orange-500 mr-3"/> Total Generated</span>
                 <span className="font-bold text-white text-xl">{totalDraftsGen.toLocaleString()}</span>
              </div>
              <div className="w-full flex justify-between items-center bg-zinc-950/80 p-4 rounded-xl border border-zinc-800/80 shadow-sm">
                 <span className="text-zinc-400 text-sm flex items-center font-medium"><div className="w-2.5 h-2.5 rounded-full bg-emerald-500 mr-3"/> Total Approved</span>
                 <span className="font-bold text-white text-xl">{totalDraftsApp.toLocaleString()}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <motion.div 
        ...
        className="order-3 xl:col-span-3 bg-zinc-900/50 border border-zinc-800/80 p-5 lg:p-6 rounded-xl flex flex-col gap-6 w-full"
      >
        <div>
          <h3 className="text-2xl font-bold text-zinc-100">AI Confidence Trend</h3>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full">
          ...
          <div className="lg:col-span-5 w-full flex flex-col justify-center space-y-6 lg:pl-6 lg:border-l border-zinc-800/50">
            ...
            <div className="flex flex-col space-y-3 pt-2 w-full">
              <div className="w-full flex justify-between items-center bg-zinc-950/80 p-4 rounded-xl border border-zinc-800/80 shadow-sm">
                 <span className="text-zinc-400 text-sm flex items-center font-medium"><div className="w-2.5 h-2.5 rounded-full bg-pink-500 mr-3"/> Average Score</span>
                 <span className="font-bold text-white text-xl">{(avgConf * 100).toFixed(1)}%</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <motion.div 
        ...
        className="order-4 xl:col-span-3 bg-zinc-900/50 border border-zinc-800/80 p-5 lg:p-6 rounded-xl flex flex-col gap-6 w-full"
      >
        <div>
          <h3 className="text-2xl font-bold text-zinc-100">Knowledge Base Scale</h3>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 w-full">
          <div className="lg:col-span-7 w-full h-[250px] sm:h-[300px] lg:h-[350px]">
            <ResponsiveContainer width="100%" height="100%">
          ...
          <div className="lg:col-span-5 w-full flex flex-col justify-center space-y-6 lg:pl-6 lg:border-l border-zinc-800/50">
            ...
            <div className="flex flex-col space-y-3 pt-2 w-full">
              <div className="w-full flex justify-between items-center bg-zinc-950/80 p-4 rounded-xl border border-zinc-800/80 shadow-sm">
                 <span className="text-zinc-400 text-sm flex items-center font-medium"><div className="w-2.5 h-2.5 rounded-full bg-teal-500 mr-3"/> Total Size</span>
                 <span className="font-bold text-white text-xl">{totalStorageMB} MB</span>
              </div>
            </div>
          </div>
        </div>
