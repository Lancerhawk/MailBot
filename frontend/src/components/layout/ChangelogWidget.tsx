...
export default function ChangelogWidget() {
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center justify-center w-5 h-5 rounded-full bg-orange-500/10 text-orange-600 group-hover:bg-orange-500/20 dark:bg-red-500/10 dark:text-red-500 dark:group-hover:bg-red-500/20 transition-colors">
